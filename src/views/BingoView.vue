  ...
  v-container.bingo.fade-in
    div(style="max-width: 500px")
      ...
      v-card.mb-4(outlined v-if="showChat")
        iframe(src="https://www.twitch.tv/embed/raceswild/chat?parent=raceswild.3and3.dev&parent=racing.3and3.dev&parent=raceswild.com&parent=localhost" frameborder="0" allowfullscreen="true" scrolling="no"  width="100%" height="600px")
</template>
